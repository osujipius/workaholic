...
export default function Reviews() {
  return (
    <div className="relative isolate bg-white pb-20 pt-20">
      <div
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="mt-2 text-4xl font-semibold tracking-tight text-gray-900 font-mono">
            Testimonials
          </h2>
          <h6 className="text-lg leading-8 font-mono text-gray-500">
